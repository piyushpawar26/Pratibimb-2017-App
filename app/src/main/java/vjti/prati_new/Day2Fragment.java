...
public class Day2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragment = inflater.inflate(R.layout.fragment_day2, container, false);
        listView = (ListView) fragment.findViewById(R.id.lv_events_day2);
        prepareData();
    ...
    public void prepareData(){
        list = new ArrayList<>();
        String[] name = {"Prati 2", "Event Name 2", "Event Name 3", "Event Name 4", "Event Name 5", "Event Name 6"};
